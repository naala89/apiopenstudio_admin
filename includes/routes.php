...
use ApiOpenStudioAdmin\Middleware\Authentication;
...
$app->get('/accounts', 'CtrlAccount:index')
    ->add(new Authentication($container, $settings, '/login'));
$app->post('/account/create', 'CtrlAccount:create')
    ->add(new Authentication($container, $settings, '/login'));
...
$app->get('/home', 'CtrlHome:index')
    ->add(new Authentication($container, $settings, '/login'));
$app->post('/', 'CtrlHome:index')
    ->add(new Authentication($container, $settings, '/login'));

/**
 * Invites
 */
$app->get('/invites', 'CtrlInvite:index')
    ->add(new Authentication($container, $settings, '/login'));
$app->post('/user/invite', 'CtrlInvite:invite')
    ->add(new Authentication($container, $settings, '/login'));
$app->get('/invite/delete/{iid}', 'CtrlInvite:delete')
    ->add(new Authentication($container, $settings, '/login'));
 ...
 * Resources.
 */
$app->get('/resources', 'CtrlResource:index')
    ->add(new Authentication($container, $settings, '/login'));
$app->get('/resource/create', 'CtrlResource:create')
    ->add(new Authentication($container, $settings, '/login'));
$app->get('/resource/edit/{resid}', 'CtrlResource:edit')
    ->add(new Authentication($container, $settings, '/login'));
$app->post('/resource/upload', 'CtrlResource:upload')
    ->add(new Authentication($container, $settings, '/login'));
$app->post('/resource/delete', 'CtrlResource:delete')
    ->add(new Authentication($container, $settings, '/login'));
$app->get('/resource/download/{format}/{resid}', 'CtrlResource:download')
    ->add(new Authentication($container, $settings, '/login'));
$app->post('/resource/import', 'CtrlResource:import')
    ->add(new Authentication($container, $settings, '/login'));

/**
 * Roles.
 */
$app->get('/roles', 'CtrlRole:index')
    ->add(new Authentication($container, $settings, '/login'));
$app->post('/role/create', 'CtrlRole:create')
    ->add(new Authentication($container, $settings, '/login'));
$app->post('/role/update', 'CtrlRole:update')
    ->add(new Authentication($container, $settings, '/login'));
$app->post('/role/delete', 'CtrlRole:delete')
    ->add(new Authentication($container, $settings, '/login'));

/**
 * Users.
 */
$app->get('/users', 'CtrlUsers:index')
    ->add(new Authentication($container, $settings, '/login'));
$app->get('/user/create', 'CtrlUser:create')
    ->add(new Authentication($container, $settings, '/login'));
$app->get('/user/view/{uid}', 'CtrlUser:view')
    ->add(new Authentication($container, $settings, '/login'));
$app->get('/user/edit/{uid}', 'CtrlUser:edit')
    ->add(new Authentication($container, $settings, '/login'));
$app->post('/user/upload', 'CtrlUser:upload')
    ->add(new Authentication($container, $settings, '/login'));
$app->get('/user/delete/{uid}', 'CtrlUser:delete')
    ->add(new Authentication($container, $settings, '/login'));

/**
 * User roles
 */
$app->get('/user/roles', 'CtrlUserRole:index')
    ->add(new Authentication($container, $settings, '/login'));
$app->post('/user/role/create', 'CtrlUserRole:create')
    ->add(new Authentication($container, $settings, '/login'));
$app->post('/user/role/delete', 'CtrlUserRole:delete')
    ->add(new Authentication($container, $settings, '/login'));

/**
 * Vars.
 */
$app->get('/vars', 'CtrlVars:index')
    ->add(new Authentication($container, $settings, '/login'));
$app->post('/var/create', 'CtrlVars:create')
    ->add(new Authentication($container, $settings, '/login'));
$app->post('/var/edit', 'CtrlVars:update')
    ->add(new Authentication($container, $settings, '/login'));
